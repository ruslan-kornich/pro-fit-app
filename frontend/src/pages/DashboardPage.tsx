  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link to="/add">
          <Card className="text-center hover:shadow-md transition-shadow py-3">
        ...
        <Link to="/recommendations">
          <Card className="text-center hover:shadow-md transition-shadow py-3">
            <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-1.5">
