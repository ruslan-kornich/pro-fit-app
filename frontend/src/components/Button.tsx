...
export default function Button({
  ...
  const variants = {
    ...
    gradient: 'text-white focus:ring-primary-500 shadow-button bg-gradient-to-br from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700',
